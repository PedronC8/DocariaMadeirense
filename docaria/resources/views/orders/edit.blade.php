                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="ready_date" class="form-control @error('ready_date') is-invalid @enderror" 
                                   value="{{ old('ready_date', $order->ready_date->format('Y-m-d')) }}" required>
                            @error('ready_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="desired_date" class="form-control" 
                                   value="{{ old('desired_date', $order->desired_date ? $order->desired_date->format('Y-m-d') : '') }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select name="trabalhador_id" class="form-select">
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}" {{ $order->trabalhador_id == $user->id ? 'selected' : '' }}>
                                        {{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="payment_method" class="form-select">
                                ...
                                <option value="cartao" {{ $order->payment_method == 'cartao' ? 'selected' : '' }}>Cartão</option>
        ...
        <div class="col-lg-4">
            <div class="card summary-card">
                ...
                <div class="card-body">
                    ...
                    <div id="orderItems">
                        <!-- Items serão atualizados dinamicamente -->
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicializar com produtos existentes
    ...
    // Atualizar sumário inicialmente
    updateSummary();
