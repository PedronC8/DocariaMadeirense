...
<head>
    ...
    <meta name="description" content="Registo - A Docaria">
    <meta name="author" content="A Docaria">
    <title>Registo - A Docaria</title>
                                ...
                                <div class="m-sm-3">
                                    <form method="post" action="{{ route('register.store') }}" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" placeholder="Digite o seu nome" required>
                                            @error('name')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg @error('password') is-invalid @enderror" type="password" name="password" placeholder="Crie uma palavra-passe" required>
                                            @error('password')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="d-grid gap-2 mt-3">
                                            <button type="submit" class="btn btn-lg btn-primary btn-login-submit">Registar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
